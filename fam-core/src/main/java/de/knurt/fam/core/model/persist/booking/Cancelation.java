 ...
 * a cancelation contains the reason, the user that canceled it and a date of cancelation
 * (that is always the construction date).
 * @see Booking
...
public class Cancelation {
    ...
    /**
     * reason for cancelation.
     * no reason given. this is used, if the reason is unclear.
     */
     ...
     * do not use this for any purposes then for mapping.
