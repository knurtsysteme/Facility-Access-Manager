...
public class Registration {
	...
	/**
	 * return password input or null, if no password is given or password input
	 * of field 1 is not the same password in field 2.
	 * 
	 ...
	 * return false if the user in the database is the user logged in or no user
	 ...
	 *            the acceptedStatementOfAgreement to set
	 */
