...
public class JSONFactory {
  ...
  /**
   * return a json representation of the given user. keys are always string.
   * 
   * the main address is a flat representation (not an json object as value). if no main address is set, values for (city etc.) are empty strings.
   * 
