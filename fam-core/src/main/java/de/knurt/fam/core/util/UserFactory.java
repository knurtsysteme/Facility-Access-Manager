...
public class UserFactory {
	...
	/**
	 * return a user from a json object. assert needed attributes set. throw
	...
	/**
	 * return a user object with all values set in json object. if no value is
	 * set, let it <code>null</code> in the user object as well. use
