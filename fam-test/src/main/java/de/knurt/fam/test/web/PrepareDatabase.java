				...
				if (request.getParameter("confirm") != null && request.getParameter("confirm").equals("1")) {
					...
					try {
						String[] sqls = {
								...
								"DELETE FROM address",
								"DELETE FROM booking",
								"DELETE FROM facility_responsibility",

								"INSERT INTO `address` VALUES (1,1,'24989','Muehlenstr','3','Dollerup','de')",
								"INSERT INTO `address` VALUES (2,1,'24989','Muehlenstr','3','Dollerup','de')",
